...
public class ServicesFragment extends Fragment implements
    ...
    private String places[] = new String[]{"Plumbers", "Electricians", "Moving companies","Accounting"};
   ...
   */
    public static ServicesFragment newInstance(int page, String city) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        RecommendedPlacesHandler recommendedPlacesHandler = new RecommendedPlacesHandler(getActivity()) {
            ...
            public void postFetchingRecomendedPlaces(ArrayList<RecommendedPlace> recomendedPlaces) {
                ServicesFragment.this.setupRecomendedPlaces(recomendedPlaces, view);
            }
        };
